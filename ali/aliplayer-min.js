        ...
        ! function() {
            ...
            function l(o, e) {
                ...
                if (e = e || {},
                    ...
                    this.tapTimeout = e.tapTimeout || 700, !l.notNeeded(o)) {
        ...
        s.exports.get = function(e, t, i, r, o) {
            ...
            s.exports.ajax = function(e, t, i, r, o, n, a, s) {
                ...
                o = o || function() {},
                    ...
                    c = h.parseUrl(t),
                    d = window.location, !(c.protocol + c.host !== d.protocol + d.host) || !window.XDomainRequest || "withCredentials" in u ? (l = "file:" == c.protocol || "file:" == d.protocol,
            ...
            function(e, t) {
                ...
                if ((r.webkit = !!o) && (r.version = o[1]),
                    ...
                    f && (i.kindle = !0,
                        i.version = f[1]),
                    _ && (r.silk = !0,
                        r.version = _[1]), !_ && i.android && e.match(/Kindle Fire/) && (r.silk = !0),
                    S && (r.chrome = !0,
                        r.version = S[1]),
                    T && (r.firefox = !0,
                        r.version = T[1]),
                ...
                i.tablet = !!(s || m || n && !e.match(/Mobile/) || T && e.match(/Tablet/) || x && !e.match(/Phone/) && e.match(/Touch/)),
                    ...
                    a ? i.name = "macOS" : d ? (i.name = "windows",
                        ...
                        return o && (t = "macOS"),
                            "X11" != navigator.platform || r || o || (t = "Unix"), -1 < String(navigator.platform).indexOf("Linux") && (t = "Linux"),
                            r ? "windows" : t
                    }(),
                    r.name = function() {
    ...
    33: [function(e, r, t) {
        ...
        r.exports.formatTime = function(e) {
                ...
                return t = Math.floor(o / 3600),
                    o %= 3600,
                    i = Math.floor(o / 60),
                    r = o % 60, !(t === 1 / 0 || isNaN(t) || i === 1 / 0 || isNaN(i) || r === 1 / 0 || isNaN(r)) && ("00" === (t = 10 <= t ? t : "0" + t) ? "" : t + ":") + (i = 10 <= i ? i : "0" + i) + ":" + (r = 10 <= r ? r : "0" + r)
            },
            ...
            a = r.extend({
                ...
                _onPlayerloadstart: function() {
                    this.loadstartTime = (new Date).getTime(),
                        this.playId = v.guid(), !this.loadstarted && this.player._isPreload() && (this.loadstarted = 1,
                            this._log("STARTPLAY", {
                                vt: (new Date).getTime()
                            }))
                },
        ...
        t.exports.handle = function(e) {
            ...
            if (i.waiting && !i._TimeUpdateStamp && (i._TimeUpdateStamp = t),
                0 != i.waiting && i._TimeUpdateStamp == t || (i.trigger(n.Private.H5_Loading_Hide),
                    ...
                    i.waiting = !1),
                i._TimeUpdateStamp = t, !i._options.isLive) {
                var r = i.getDuration(),
                    o = !1;
            ...
            P = n.extend({
                init: function(e, t) {
                    if (this.tag = e,
                        ...
                        this._overrideNativePlay(), !this._liveshiftService || this._liveshiftService.validate()) {
        ...
        P.prototype.initPlay = function(e) {
            ...
            P.prototype.checkOnline = function() {
                ...
                return e.display_msg = _.get("Error_Offline_Text"),
                    this.trigger(T.Player.Error, e), !1
            },
            ...
            P.prototype._initPlayBehavior = function(e, t) {
                ...
                if (p.validateSource(t))
                    return void 0 === e && (e = !1),
                        ...
                        this._options.autoplay || this._options._autoplay || this._options.preload || e ? (this._options._preload = !0,
                            this._initLoad(t),
                            (this._options.autoplay || this._options._autoplay) && this._startPlay()) : this.trigger(T.Private.Play_Btn_Show), !0;
                var i = {
                    mediaId: this._options.vid ? this._options.vid : "",
                ...
                return i.display_msg = _.get("Error_Invalidate_Source"),
                    this.trigger(T.Player.Error, i), !1
            },
            ...
            P.prototype._overrideNativePlay = function() {
                ...
                this.tag.play = function() {
                    ...
                    void 0 !== t && t.then(function() {
                        ...
                        console.log("do play failed"), !o.tag || !o.tag.paused || o._isError || o._options._autoplay || o._switchedLevel || (o.trigger(T.Private.Play_Btn_Show),
            ...
            P.prototype._reloadForVod = function() {
                if (this._originalSource || (this._originalSource = this._options.source),
                    ...
                    return console.log("_reloadForVod"),
                        ...
                        this._vodRetryCount = this._vodRetryCount + 1, !0
                }
                return !1
            },
            t.exports = P
                ...
                if (e && s.isArray(e) && 0 < e.length)
                    for (var i = 0; i < e.length; i++) {
                        ...
                        if (constr = void 0 === r.type ? r : r.type,
                            ...
                            name = void 0 === r.name ? "" : r.name, !constr)
            ...
            if (o || function(e, t) {
                ...
                e._Type = t,
                    ...
                    t.prototype.getProgramDateTime = function() {
                        if (this._checkFlvReady(), !this._metadata)
                            return "";
            ...
            n.prototype.reloadNewVideoInfo = function(e, t, i, r, o, n) {
                if (this.trigger("error_hide"),
                    ...
                    e && (this._options.vid = e,
                        ...
                        this._options.authInfo = o), !(this._options.vid && this._options.accId && this._options.accessSecret && this._options.stsToken && this._options.domainRegion && this._options.authInfo))
    ...
    89: [function(e, t, i) {
        ...
        r.prototype.validate = function() {
            ...
            r.prototype.getTimeline = function(i, r) {
                if (this._player.trigger(c.Private.LiveShiftQueryCompleted), !this._liveShiftUrl)
                ...
                if (e = (i = this).options().children)
                    if (a.isArray(e))
                        for (var n = 0; n < e.length; n++)
                            o = "string" == typeof(t = e[n]) ? (r = t, {}) : (r = t.name,
                                t),
                            i.addChild(r, o);
                    else
            ...
            l = r.extend({
                ...
                bindEvent: function() {
                    ...
                    this._player.on(o.Player.RequestFullScreen, function() {
                        ...
                        console.log(this, "00000000000000000000000")
                    this.on("click", function() {
    ...
    105: [function(e, t, i) {
        var r = e("../component"),
            ...
            s = r.extend({
                ...
                createEl: function() {
                    var e = r.prototype.createEl.call(this);
                    return e.innerHTML = '<div class="bgPlayer"></div><div class="btnClick ispaseImg"></div> <div class="add15s"></div> <div class="back15s"></div>  <div class="qinxidu">1080</div> <div class="beishu">1x</div><div class="xgplayer-playbackrate"><li class="1x beishuactive">1x</li><li class="15x">1.5x</li><li class="2x">2x</li></div><div class="zhuanId"></div> ',
                        e
                },
            });
        t.exports = s
            ...
            d = a.extend({
                ...
                createEl: function() {
                    var e = a.prototype.createEl.call(this, "div"),
                        t = "<div class='prism-setting-item prism-setting-{type}' type={type}><div class='setting-content'><span class='array'></span><span class='current-setting'>{value}</span></div></div>",
                ...
                bindEvent: function() {
                    ...
                    console.log(t(), "^^^^^^^^^^^", this.el().lastChild, e)
