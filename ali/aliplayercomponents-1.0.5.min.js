! function(A) {
    ...
    e.m = A, e.c = t, e.d = function(A, t, n) { e.o(A, t) || Object.defineProperty(A, t, { enumerable: !0, get: n }) }, e.r = function(A) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(A, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(A, "__esModule", { value: !0 }) }, e.t = function(A, t) {
        ...
        if (e.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: A }), 2 & t && "string" != typeof A)
            for (var i in A) e.d(n, i, function(t) { return A[t] }.bind(null, i));
        return n
    }, e.n = function(A) { var t = A && A.__esModule ? function() { return A.default } : function() { return A }; return e.d(t, "a", t), t }, e.o = function(A, t) { return Object.prototype.hasOwnProperty.call(A, t) }, e.p = "", e(e.s = 29)
}([function(A, t) {
    A.exports = function(A) {
        ...
        return t.toString = function() {
                ...
                var e = function(A, t) {
                    ...
                    if (t && "function" == typeof btoa) {
                        var o = (e = i, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(e)))) + " */"),
                            r = i.sources.map(function(A) { return "/*# sourceURL=" + i.sourceRoot + A + " */" });
            ...
            for (var n = {}, i = 0; i < this.length; i++) { var o = this[i][0]; "number" == typeof o && (n[o] = !0) }
            for (i = 0; i < A.length; i++) { var r = A[i]; "number" == typeof r[0] && n[r[0]] || (e && !r[2] ? r[2] = e : e && (r[2] = "(" + r[2] + ") and (" + e + ")"), t.push(r)) }
        }, t
    }
}, function(A, t, e) {
    var n, i, o = {},
        r = (n = function() { return window && document && document.all && !window.atob }, function() { return void 0 === i && (i = n.apply(this, arguments)), i }),
        a = function(A) {
            var t = {};
            return function(A) {
                if ("function" == typeof A) return A();
                if (void 0 === t[A]) {
                    var e = function(A) { return document.querySelector(A) }.call(this, A);
    ...
    function u(A, t) {
        for (var e = 0; e < A.length; e++) {
            var n = A[e],
                i = o[n.id];
            if (i) { i.refs++; for (var r = 0; r < i.parts.length; r++) i.parts[r](n.parts[r]); for (; r < n.parts.length; r++) i.parts.push(f(n.parts[r], t)) } else {
                var a = [];
    ...
    function h(A, t) {
        ...
        var n = c[c.length - 1];
        if ("top" === A.insertAt) n ? n.nextSibling ? e.insertBefore(t, n.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild), c.push(t);
    ...
    function m(A) { var t = document.createElement("style"); return void 0 === A.attrs.type && (A.attrs.type = "text/css"), g(t, A.attrs), h(A, t), t }

    function g(A, t) { Object.keys(t).forEach(function(e) { A.setAttribute(e, t[e]) }) }
    ...
    function f(A, t) {
        ...
        }.bind(null, e, t), i = function() { y(e), e.href && URL.revokeObjectURL(e.href) }) : (e = m(t), n = function(A, t) {
            var e = t.css,
                n = t.media;
    ...
    var v, M = (v = [], function(A, t) { return v[A] = t, v.filter(Boolean).join("\n") });
    ...
    var e = function() {
            var A = {
                ...
                binsert: function(t, e, n) { var i = A.bsearch(t, e, n); return t.splice(i, 0, e), i }
            };
            return A
        }(),
        ...
        i = function() {
            ...
            return A.prototype.willCollide = function(A, t) { return A.stime + A.ttl >= t.stime + t.ttl / 2 }, A.prototype.pathCheck = function(A, t, e) {
                for (var n = A + t.height, i = t.right, o = 0; o < e.length; o++)
                    if (!(e[o].y > n || e[o].bottom < A)) { if (!(e[o].right < t.x || e[o].x > i)) return !1; if (this.willCollide(e[o], t)) return !1 }
                return !0
            ...
            }, A.prototype.add = function(A) { A.height > this._height ? (A.cindex = -2, A.y = 0) : (A.y = this.assign(A, 0), e.binsert(this._pools[A.cindex], A, function(A, t) { return A.bottom < t.bottom ? -1 : A.bottom > t.bottom ? 1 : 0 })) }, A.prototype.remove = function(A) {
                if (!(A.cindex < 0)) {
            ...
            }, A.prototype.setBounds = function(A, t) { this._width = A, this._height = t }, A
        }(),
        o = function(A) {
            function t() { A.apply(this, arguments) }
            return n(t, A), t.prototype.add = function(t) { A.prototype.add.call(this, t), t.x = (this._width - t.width) / 2 }, t.prototype.willCollide = function(A, t) { return !0 }, t.prototype.pathCheck = function(A, t, e) {
        ...
        r = (n = this && this.__extends || function(A, t) {
            ...
            return A.prototype.init = function(A) { void 0 === A && (A = null), this.dom = null !== A ? A.dom : document.createElement("div"), this.dom.className = this.parent.options.global.className, this.dom.appendChild(document.createTextNode(this.text)), this.dom.textContent = this.text, this.dom.innerText = this.text, this.size = this._size, 16777215 != this._color && (this.color = this._color), this.shadow = this._shadow, this._border && (this.border = this._border), "" !== this._font && (this.font = this._font), void 0 !== this._x && (this.x = this._x), void 0 !== this._y && (this.y = this._y), (1 !== this._alpha || this.parent.options.global.opacity < 1) && (this.alpha = this._alpha), this.motion.length > 0 && this.animate() }, Object.defineProperty(A.prototype, "x", { get: function() { return null !== this._x && void 0 !== this._x || (this.align % 2 == 0 ? this._x = this.dom.offsetLeft : this._x = this.parent.width - this.dom.offsetLeft - this.width), this.absolute ? this._x : this._x / this.parent.width }, set: function(A) { this._x = A, this.absolute || (this._x *= this.parent.width), this.align % 2 == 0 ? this.dom.style.left = this._x + "px" : this.dom.style.right = this._x + "px" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "y", { get: function() { return null !== this._y && void 0 !== this._y || (this.align < 2 ? this._y = this.dom.offsetTop : this._y = this.parent.height - this.dom.offsetTop - this.height), this.absolute ? this._y : this._y / this.parent.height }, set: function(A) { this._y = A, this.absolute || (this._y *= this.parent.height), this.align < 2 ? this.dom.style.top = this._y + "px" : this.dom.style.bottom = this._y + "px" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "bottom", { get: function() { return this.y + this.height }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "right", { get: function() { return this.x + this.width }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "width", { get: function() { return null !== this._width && void 0 !== this._width || (this._width = this.dom.offsetWidth), this._width }, set: function(A) { this._width = A, this.dom.style.width = this._width + "px" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "height", { get: function() { return null !== this._height && void 0 !== this._height || (this._height = this.dom.offsetHeight), this._height }, set: function(A) { this._height = A, this.dom.style.height = this._height + "px" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "size", { get: function() { return this._size }, set: function(A) { this._size = A, this.dom.style.fontSize = this._size + "px" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "color", {
                ...
                enumerable: !0,
                configurable: !0
            }), Object.defineProperty(A.prototype, "alpha", { get: function() { return this._alpha }, set: function(A) { this._alpha = A, this.dom.style.opacity = Math.min(this._alpha, this.parent.options.global.opacity) + "" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "border", { get: function() { return this._border }, set: function(A) { this._border = A, this._border ? this.dom.style.border = "1px solid #00ffff" : this.dom.style.border = "none" }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "shadow", { get: function() { return this._shadow }, set: function(A) { this._shadow = A, this._shadow || (this.dom.className = this.parent.options.global.className + " noshadow") }, enumerable: !0, configurable: !0 }), Object.defineProperty(A.prototype, "font", { get: function() { return this._font }, set: function(A) { this._font = A, this._font.length > 0 ? this.dom.style.fontFamily = this._font : this.dom.style.fontFamily = "" }, enumerable: !0, configurable: !0 }), A.prototype.time = function(A) { this.ttl -= A, this.ttl < 0 && (this.ttl = 0), this.movable && this.update(), this.ttl <= 0 && this.finish() }, A.prototype.update = function() { this.animate() }, A.prototype.invalidate = function() { this._x = null, this._y = null, this._width = null, this._height = null }, A.prototype._execMotion = function(A, t) {
                for (var e in A)
     ...
     */
    ! function() {
        var A = function(A, t) { for (var e = Math.PI / 180, n = A * e, i = t * e, o = Math.cos, r = Math.sin, a = [o(n) * o(i), o(n) * r(i), r(n), 0, -r(i), o(i), 0, 0, -r(n) * o(i), -r(n) * r(i), o(n), 0, 0, 0, 0, 1], l = 0; l < a.length; l++) Math.abs(a[l]) < 1e-6 && (a[l] = 0); return "matrix3d(" + a.join(",") + ")" };

        function t(A) {
            var t = 0;
            this._listeners = {}, this._lastPosition = 0, this.stage = A, this.options = { global: { opacity: 1, scale: 1, className: "cmt" }, scroll: { opacity: 1, scale: 1 }, limit: 0 }, this.timeline = [], this.runline = [], this.position = 0, this.limiter = 0, this.filter = null, this.csa = { scroll: new i(0, 0), top: new o(0, 0), bottom: new o(0, 0), reverse: new i(0, 0), scrollbtm: new i(0, 0) }, this.width = this.stage.offsetWidth, this.height = this.stage.offsetHeight, this.startTimer = function() {
                if (!(t > 0)) {
        ...
        }, t.prototype.time = function(A) { if (A -= 1, this.position >= this.timeline.length || Math.abs(this._lastPosition - A) >= 2e3) { if (this.seek(A), this._lastPosition = A, this.timeline.length <= this.position) return } else this._lastPosition = A; for (; this.position < this.timeline.length && this.timeline[this.position].stime <= A; this.position++) this.options.limit > 0 && this.runline.length > this.limiter || this.validate(this.timeline[this.position]) && this.send(this.timeline[this.position]) }, t.prototype.rescale = function() {}, t.prototype.send = function(t) {
            if (8 !== t.mode) {
        ...
        }, t.prototype.sendComment = function(A) { this.send(A) }, t.prototype.finish = function(A) {
        ...
        }, t.prototype.addEventListener = function(A, t) { void 0 !== this._listeners[A] ? this._listeners[A].push(t) : this._listeners[A] = [t] }, t.prototype.dispatchEvent = function(A, t) {
            if (void 0 !== this._listeners[A])
                for (var e = 0; e < this._listeners[A].length; e++) try { this._listeners[A][e](t) } catch (A) { console.err(A.stack) }
    ...
    A.exports = function(A) {
        ...
        return A.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(A, t) { var i, o = t.trim().replace(/^"(.*)"$/, function(A, t) { return t }).replace(/^'(.*)'$/, function(A, t) { return t }); return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o) ? A : (i = 0 === o.indexOf("//") ? o : 0 === o.indexOf("/") ? e + o : n + o.replace(/^\.\//, ""), "url(" + JSON.stringify(i) + ")") })
    }
}, function(A, t, e) {
    var n = e(34);
    "string" == typeof n && (n = [
    ...
    function c(A) { var t = document.createElement("div"); return t.innerHTML = A, t.childNodes[0] }

    function d(A) { return A instanceof Element && A.nodeType === Node.ELEMENT_NODE }
    e(33);
    var u = function() {
            function A(A, t) {
            ...
            return function(t, e, n) { return e && A(t.prototype, e), n && A(t, n), t }
        }(),
        p = function() {
            function A(t) { var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "controlbar";! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.sendEl = e, this.danmukuList = t, this.html = c(i.a), this.danmuControlHtml = c(r.a), this.sendEl = e, this.danmuInput = null === e ? null : c(l.a), this.CM = null, this.userDanmuOpen = !0 }
            return u(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this,
                    ...
                    r ? A.insertBefore(this.html, r) : A.appendChild(this.html), this.CM = new s.CommentManager(this.html.querySelector(".danmu")), this.CM.init(), this.CM.load(this.danmukuList), A.querySelector("video").ontimeupdate = function() { null !== A.querySelector("video") && e.CM.time(1e3 * A.querySelector("video").currentTime) };
                    var a = this.danmuControlHtml.querySelector(".icon-danmu-close"),
                        l = this.danmuControlHtml.querySelector(".icon-danmu-open");
                    if (a.onclick = function() { e.userDanmuOpen = !1, a.style.display = "none", l.style.display = "inline-block", e.CM.clear(), e.CM.stop() }, l.onclick = function() { l.style.display = "none", a.style.display = "inline-block", e.userDanmuOpen = !0, e.CM.start() }, null !== this.danmuInput) {
                        var c = this.danmuInput.querySelector(".ali-danmu-input input");
                        this.danmuInput.querySelector(".danmu-input-enter").onclick = this.sendDanmuHandle.bind(this), c.onkeydown = function(A) { 13 === A.keyCode && e.sendDanmuHandle.call(e) }
                    }
                }
            }, {
                key: "sendDanmuHandle",
                value: function() {
                    var A = this.danmuInput.querySelector(".ali-danmu-input input"),
                        t = A.value;
                    "" !== t && (this.send({ mode: 1, text: t, stime: 1e3, size: [16, 18, 25, 36, 45][this.randomIndex(5)], color: [16777215, 255, 13369344, 16738047, 16777011][this.randomIndex(5)] }), A.value = "", A.focus())
                }
            }, { key: "randomIndex", value: function(A) { return Math.floor(Math.random() * A) } }, { key: "play", value: function(A, t) { this.userDanmuOpen && this.CM.start() } }, { key: "pause", value: function(A, t) { this.userDanmuOpen && this.CM.stop() } }, { key: "send", value: function(A) { this.CM.send(A) } }, { key: "insert", value: function(A) { this.CM && this.CM.insert(A) } }, { key: "dispose", value: function() { null !== this.danmuInput && this.danmuInput.parentNode && this.danmuInput.parentNode.removeChild(this.danmuInput) } }]), A
        }(),
        h = e(9),
        y = e.n(h),
        m = (e(35), function() {
        ...
        g = function() {
            function A(t, e) { var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "random";! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.text = t, this.style = e || { fontSize: "14px", color: "#fff" }, this.html = c(y.a), this.bulletPosition = n }
            return m(A, [{ key: "createEl", value: function(A, t) { this.html.innerText = this.text, A.appendChild(this.html) } }, {
                key: "ready",
                value: function(A, t) {
                    var e = this;
                    A.getOptions(), !1 === A.getOptions().autoplay && (this.html.style.animationPlayState = "paused"), Object.keys(this.style).forEach(function(A) { return e.html.style[A] = e.style[A] });
                    ...
                    "random" === this.bulletPosition && this.html.addEventListener("animationiteration", function() { e.html.style.top = e.randomTop(i) })
                }
            }, { key: "playing", value: function(A, t) { this.html.style.animationPlayState = "running" } }, {
                key: "timeupdate",
                value: function(A, t) {
                    var e = A.el(),
            ...
            }, { key: "pause", value: function(A, t) { this.html.style.animationPlayState = "paused" } }, { key: "randomTop", value: function(A) { return Math.floor(Math.random() * A) + "px" } }]), A
        }(),
        f = e(10),
        v = e.n(f),
        M = (e(37), function() {
        ...
        x = function() {
            function A() {
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    e = arguments[1],
                    n = arguments[2];
                ! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.html = c(v.a), this.autoPlay = t, this.getTime = e || this._getTime, this.saveTimeFunction = n || this._saveTime, this.hasMemoryDisplay = !1
            }
            return M(A, [{ key: "createEl", value: function(A) { A.appendChild(this.html) } }, {
                key: "ready",
                value: function(A, t) {
                    var e = this,
                        n = A.getOptions(),
                    ...
                    if (null !== (o = o ? parseInt(o) : 0) && 0 !== o && !this.hasMemoryDisplay)
                        if (this.hasMemoryDisplay = !0, this.autoPlay) A.seek(o), "playing" !== A.getStatus() && A.play();
                            ...
                            if (o !== parseInt(A._duration)) {
                                ...
                                var l = setTimeout(function() { e.html.innerHTML = "" }, 15e3);
                                this.html.querySelector(".icon-close").onclick = function() { e.html.innerHTML = "", clearTimeout(l) }, this.html.querySelector(".play-jump").onclick = function() { A.seek(o), "playing" !== A.getStatus() && A.play(), e.html.innerHTML = "", clearTimeout(l) }
                            }
                        }
                    var s = this;
                    document.onvisibilitychange = function() { "hidden" === document.visibilityState && 0 !== A.getCurrentTime() && s.saveTimeFunction(i, A.getCurrentTime()) }, window.onbeforeunload = function() { 0 !== A.getCurrentTime() && s.saveTimeFunction(i, A.getCurrentTime()) }
                }
            }, { key: "error", value: function(A, t) { this.setMemory(A) } }, { key: "dispose", value: function(A, t) { this.setMemory(A) } }, {
                key: "setMemory",
                value: function(A) {
                    var t = A.getOptions(),
            ...
            }, { key: "_getTime", value: function(A) { return localStorage.getItem(A) } }, { key: "_saveTime", value: function(A, t) { localStorage.setItem(A, t) } }]), A
        }(),
        b = e(11),
        N = e.n(b),
        w = (e(39), function() {
        ...
        I = function() {
            function A(t, e) {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.coverUrl = t, this.adUrl = e, this.html = c(N.a) }
            return w(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this,
                    ...
                    i.setAttribute("href", this.adUrl), o.setAttribute("src", this.coverUrl), this.html.querySelector(".btn-close").onclick = function() { e.html.style.display = "none" }, A.appendChild(this.html)
                }
            }, { key: "play", value: function(A, t) { this.html.style.display = "none" } }, { key: "pause", value: function(A, t) { this.html.style.display = "block" } }]), A
        }(),
        T = e(12),
        D = e.n(T),
        E = e(13),
        ...
        C = function() {
            function A(t) {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.controlHtml = c(D.a), this.listHtml = c(Q.a), this.playlist = t, this.playingVideoIndex = 0, this.listHideTimeout = null }
            return B(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this,
                    ...
                    i.insertBefore(this.controlHtml, o), this.listHtml.onmouseleave = function() { e.listHtml.style.width = 0 }, this.listHtml.onmouseenter = this.clearHideListTimeout.bind(this), this.controlHtml.querySelector(".icon-list").onclick = this.tooglePlaylist.bind(this), this.listHtml.querySelector(".list").innerHTML = this.computedListDom(this.playlist);
                    var r = t.getOptions() && t.getOptions().source,
                        a = 0;
                    r && (a = (a = this.playlist.findIndex(function(A) { return A.source === r })) > -1 ? a : 0, this.playingVideoIndex = a > -1 ? a : 0), this.listHtml.querySelector(".list").childNodes[0].className = "video-item active", A.appendChild(this.listHtml)
                }
            }, {
                key: "ready",
                value: function(A, t) {
                    var e = this;
                    this.controlHtml.querySelector(".icon-skip-previous").onclick = function() { 0 !== e.playingVideoIndex ? e.playVideo(A, e.playingVideoIndex - 1) : e.playlistTip(e.isEn ? "Already the first one~" : "已经是第一个了~", A._el) }, this.controlHtml.querySelector(".icon-skipnext").onclick = function() { e.playingVideoIndex !== e.playlist.length - 1 ? e.playVideo(A, e.playingVideoIndex + 1) : e.playlistTip(e.isEn ? "Already the last one~" : "已经是最后一个了~", A._el) }, this.listHtml.querySelector(".list").onclick = function(t) {
                        var n = t.target;
            ...
            }, { key: "clearHideListTimeout", value: function() { null !== this.listHideTimeout && (clearTimeout(this.listHideTimeout), this.listHideTimeout = null) } }, { key: "playVideo", value: function(A, t) { this.playingVideoIndex !== t && (this.playingVideoIndex = parseInt(t), A.loadByUrl(this.playlist[t].source), this.listHtml.querySelector(".video-item.active").className = "video-item", this.listHtml.querySelector(".list").childNodes[t].className = "video-item active") } }, {
                key: "tooglePlaylist",
                value: function() {
                    var A = this;
                    this.clearHideListTimeout(), "30%" === this.listHtml.style.width ? this.listHtml.style.width = 0 : (this.listHtml.style.width = "30%", this.listHideTimeout = setTimeout(function() { A.listHtml.style.width = 0 }, 5e3))
                }
            }, {
                key: "playlistTip",
                value: function(A, t) {
                    var e = document.createElement("div");
                    e.className = "playlist-skip-tip", e.innerText = A, t.appendChild(e), setTimeout(function() { t.removeChild(e) }, 3e3)
                }
            }, { key: "computedListDom", value: function(A) { return A.map(function(A, t) { return '<div class="video-item" data-index="' + t + '" title="' + A.name + '">' + A.name + "</div>" }).join("") } }]), A
        }(),
        k = e(14),
        j = e.n(k),
        L = (e(43), function() {
        ...
        S = function() {
            function A(t) {
                ...
                ! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.previewDuration = t, this.html = c(j.a), null !== e && this.insertHTtml(e, "previewEndHtml"), null !== n && this.insertHTtml(n, "previewBarHtml")
            }
            return L(A, [{ key: "play", value: function(A) { this.previewEnd && (A._el.querySelector(".center").classList.remove("preview-hide"), A.seek(0), this.previewEnd = !1) } }, {
                key: "insertHTtml",
                value: function(A, t) {
                ...
                value: function(A, t) {
                    ...
                    l ? A.insertBefore(this.html, l) : A.appendChild(this.html), this.html.querySelector(".preview-vod-close").addEventListener("click", function() { e.html.querySelector(".preview-component-tip").style.display = "none" }), t.setPreviewTime(Number(this.previewDuration))
                }
            }, { key: "closePreviewLayer", value: function() { this.previewEnd = !1, this.html.querySelector(".preview-component-layer").style.display = "none" } }, {
                key: "timeupdate",
                value: function(A) {
            ...
            }, { key: "ended", value: function(A, t) { A.isPreview() && (this.html.querySelector(".preview-component-layer").style.display = "block") } }]), A
        }(),
        z = e(15),
        O = e.n(z),
        Y = (e(45), function() {
        ...
        U = function() {
            function A() {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.html = c(O.a), this.imgEle = this.html.querySelector(".img-wrap img"), this.timeEle = this.html.querySelector(".time"), this.playBtnEle = this.html.querySelector(".pregress-play-btn"), this.describeEle = this.html.querySelector(".describe"), this.timer = null, this.currentOffset = null }
            return Y(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this;
                    A.appendChild(this.html), this.html.onmouseenter = function() { null !== e.timer && (clearTimeout(e.timer), e.timer = null) }, this.html.onmouseleave = function() { e.html.style.display = "none" }, this.html.onclick = function() { e.html.style.display = "none" }, this.html.querySelector(".pregress-play-btn").addEventListener("click", function() { t.seek(e.currentOffset) })
                }
            }, {
                key: "markerDotOver",
                value: function(A, t) {
                ...
                value: function(A, t) {
                    var e = this;
                    this.timer = setTimeout(function() { e.html.style.display = "none" }, 100)
                }
            }]), A
        }(),
        G = e(16),
        ...
        q = function() {
            function A(t) {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.html = c(F.a), this.modalHtml = c(Z.a), this.hasCreated = !1, this.definition = "", this.getQuality = t }
            return V(A, [{
                key: "createEl",
                value: function(A, t) {
                ...
                value: function(A) {
                    ...
                    var e = this.html.querySelector(".current-quality"),
                        ...
                        bool = true,
                        i = this._urls.map(function(A) { return '<li data-def="' + A.definition + '">' + A.desc + "</li>" });
                    ...
                    var o = null;
                    e.onclick = function() {
                        if (bool) { n.style.display = "block"; } else {
                            n.style.display = "none";
                        }
                        bool = !bool;
                    }, e.onmouseleave = function() { o = setTimeout(function() { n.style.display = "none" }, 100) }, n.onmouseenter = function() { clearTimeout(o) }, n.onmouseleave = function() { n.style.display = "none" }, n.onclick = function(e) {
                        var n = e.target,
                            i = n.dataset.def,
                            o = n.innerText;
                        if (i && "current" !== n.className) {
                            var r = t._urls.find(function(A) { return A.definition === i });
        ...
        W = function() {
            function A() {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.html = c(R.a) }
            return J(A, [{ key: "createEl", value: function(A) { A.querySelector(".prism-controlbar").appendChild(this.html) } }, {
                key: "ready",
                value: function(A, t) {
                    ...
                    o && o.classList.add("player-hidden"), e.onclick = function() { n.style.display = "block" }, e.onmouseleave = function() { i = setTimeout(function() { n.style.display = "none" }, 100) }, n.onmouseenter = function() { clearTimeout(i) }, n.onmouseleave = function() { n.style.display = "none" }, n.onclick = function(t) {
                        var i = t.target,
                            o = i.dataset.rate;
                        if (o) {
        ...
        $ = function() {
            function A() {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.html = c(X.a) }
            return _(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = t._options && t._options.language;
                ...
                value: function(A, t) {
                    ...
                    }, e.onmouseleave = function() { this.style.display = "none" }, e.onclick = function(t) {
                        var e = t.target;
        ...
        nA = function() {
            function A(t, e, n) {
                if (function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.coverUrl = t, this.adUrl = e, this.adDuration = n, n <= 0) throw Error("adDuration must must be greater than 0");
                this.html = c(tA.a)
            }
            return eA(A, [{
                key: "createEl",
                        ...
                        var o = this.adDuration,
                            ...
                            a = setInterval(function() {
                                if (o -= 1, r.innerText = o, 0 === o) {
                                    ...
                                    i && (i = parseInt(i));
                                    var l = (t.getOptions() && t.getOptions().components).find(function(A) { return "MemoryPlayComponent" === A.type.name });
                                    (!l || !l.args[0] || t.getCurrentTime() >= i) && t.play()
                                }
                            }, 1e3)
                    }
                }
            }, { key: "removeComponent", value: function() { this.html.parentNode.removeChild(this.html), this.html = null } }, { key: "ready", value: function(A) { null !== this.html && A.pause() } }]), A
        }(),
        iA = e(21),
        oA = e.n(iA),
        rA = (e(58), e(22)),
        aA = e.n(rA),
        lA = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(A) { return typeof A } : function(A) { return A && "function" == typeof Symbol && A.constructor === Symbol && A !== Symbol.prototype ? "symbol" : typeof A },
        sA = "function" == typeof Symbol && "symbol" === lA(Symbol.iterator) ? function(A) { return void 0 === A ? "undefined" : lA(A) } : function(A) { return A && "function" == typeof Symbol && A.constructor === Symbol && A !== Symbol.prototype ? "symbol" : void 0 === A ? "undefined" : lA(A) },
        cA = window.device,
        dA = {},
        uA = [];
    window.device = dA;
    ...
    function mA(A) { return -1 !== hA.indexOf(A) }

    function gA(A) { return pA.className.match(new RegExp(A, "i")) }
    ...
    function vA(A) { gA(A) && (pA.className = pA.className.replace(" " + A, "")) }

    function MA() { dA.landscape() ? (vA("portrait"), fA("landscape"), xA("landscape")) : (vA("landscape"), fA("portrait"), xA("portrait")), wA() }

    function xA(A) { for (var t in uA) uA[t](A) }
    ...
    function wA() { dA.orientation = NA(["portrait", "landscape"]) }
    ...
    function DA(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }
    var EA = function() {
            function A(t, e, n) {
            ...
            return TA(A, [{
                ...
                value: function(A, t) {
                    ...
                    var o = this;
                    this.html.querySelector(".icon-player-play").onclick = function() { e.playVideoAd(), e.html.querySelector(".autoplay-video-ad").style.display = "none" }, i.addEventListener("canplay", function A() { i.removeEventListener("canplay", A), document.getElementById("loadflag").style.display = "none", o.adDuration = Math.ceil(i.duration), o.html.querySelector("#video-ad-duration").innerText = o.adDuration, i.play().then(function() { o.setAdInterval() }).catch(function(A) { o.html.querySelector(".autoplay-video-ad").style.display = "block" }) });
                ...
                value: function(A, t) {
                    var e = this;
                    null !== this.html && (A.pause(), this.player = A, this.html.querySelector(".video-ad-close label").onclick = function() { "function" == typeof e.adCloseFunction ? e.adCloseFunction(e) : e.closeVideoAd(), document.getElementById("player-con").getElementsByTagName("video")[0].play() })
                }
            }, { key: "pauseVideoAd", value: function() { this.clearAdInterval(), this.html.querySelector("#video-ad-content").pause() } }, { key: "playVideoAd", value: function() { this.setAdInterval(), this.html.querySelector("#video-ad-content").play() } }, { key: "clearAdInterval", value: function() { null !== this.adInterval && clearInterval(this.adInterval), this.adInterval = null } }, {
                key: "setAdInterval",
                value: function() {
                    var A = this,
                        t = this.html.querySelector("#video-ad-duration");
                    this.adInterval = setInterval(function() { A.adDuration -= 1, A.adDuration <= 0 ? (A.closeVideoAd(), document.getElementById("player-con").getElementsByTagName("video")[0].play()) : t.innerText = A.adDuration }, 1e3)
                }
            }, { key: "closeVideoAd", value: function() { this.clearAdInterval(), this.html.parentNode.removeChild(this.html), this.html = null, this.player.getOptions().autoplay && this.player.play() } }]), A
        }(),
        QA = function() {
            function A(t, e, n) {
                var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "关闭广告";
            ...
            return TA(A, [{
                ...
                value: function(A) {
                    var t = this;
                    if (this.player = A, this.vdSource = A.getOptions().source, A.loadByUrl(this.adVideoSource), this.html.querySelector(".autoplay-video-ad").onclick = function() { null !== t.adDuration && (A.loadByUrl(t.adVideoSource), t.html.parentNode.querySelector(".prism-big-play-btn").click()) }, null === this.adDuration) {
                ...
                value: function(A) {
                    var t = this;
                    this.html.querySelector(".video-ad-close label").onclick = function() { "function" == typeof t.adCloseFunction ? t.adCloseFunction(t) : t.closeVideoAd(), document.getElementById("player-con").getElementsByTagName("video")[0].play() }
                }
            }, {
                key: "setAdInterval",
                value: function() {
            ...
            }, { key: "clearAdInterval", value: function() { null !== this.adInterval && clearInterval(this.adInterval), this.adInterval = null } }, { key: "playVideoAd", value: function() { this.setAdInterval(), this.player.play() } }, { key: "pauseVideoAd", value: function() { this.clearAdInterval(), this.player.pause() } }]), A
        }(),
        BA = EA;
    IA.mobile() && (BA = QA);
    var CA = BA,
        ...
        OA = function() {
            function A() {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.captionList = null, this.html = c(jA.a), this.modalHtml = c(SA.a), this.hasCreated = !1, this.definition = "" }
            return zA(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this,
                    ...
                    this.isEn = n && "en-us" === n, this.modalHtml.querySelector(".switchimg").innerText = this.isEn ? "Switching to you for" : "字幕切换到", this.modalHtml.querySelector(".switchimg").style.display = "none", A.querySelector(".prism-controlbar").appendChild(this.html), A.appendChild(this.modalHtml), t.on("textTrackReady", function(A) {
                        var t = A.paramData;
                        e.captionList = t;
                        var n = t.map(function(A) { return '<li data-def="' + A.value + '">' + A.text + "</li>" });
                    ...
                    var r = null;
                    i.onclick = function() { o.style.display = "block" }, i.onmouseleave = function() { r = setTimeout(function() { o.style.display = "none" }, 100) }, o.onmouseenter = function() { clearTimeout(r) }, o.onmouseleave = function() { o.style.display = "none", e.modalHtml.style.display = "none" }, o.onclick = function(A) {
                        var n = A.target,
                            i = n.dataset.def;
                        if (i && "current" !== n.className) {
                            var o = e.captionList.find(function(A) { return A.value === i });
                ...
                value: function(A, t) {
                    ...
                    o.forEach(function(t) { t.innerText === A && (t.className = "current") }), o && (o.className = "current")
                }
        ...
        ZA = function() {
            function A() {! function(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, A), this.trackList = null, this.html = c(UA.a), this.modalHtml = c(FA.a), this.hasCreated = !1, this.definition = "" }
            return HA(A, [{
                key: "createEl",
                value: function(A, t) {
                    var e = this,
                    ...
                    i.onclick = function() { o.style.display = "block" }, i.onmouseleave = function() { r = setTimeout(function() { o.style.display = "none" }, 100) }, o.onmouseenter = function() { clearTimeout(r) }, o.onmouseleave = function() { o.style.display = "none", e.modalHtml.style.display = "none" }, o.onclick = function(A) {
                        var n = A.target,
                            i = n.dataset.def;
                        if (i && "current" !== n.className) {
                            var o = e.trackList.find(function(A) { return A.value.toString() === i });
    ...
    function WA(A, t) { if (!(A instanceof t)) throw new TypeError("Cannot call a class as a function") }
    var KA = function() {
            function A(t, e) {
            ...
            return JA(A, [{
                ...
                key: "created",
                value: function(A) {
                    var t = this.adVideoSource.map(function(A, t) { return '<video id="many-video-ad-content' + (t + 1) + '" style="' + (0 === t ? "display: block" : "display:none") + ';width:100%;height:100%" x5-video-player-type="h5" x5-video-player-fullscreen="false" src="' + A.adVideo + '"></video>' });
                    ...
                    var e = this.indexVideo,
                        ...
                        a = this,
                        l = i.play();
                    void 0 !== l && l.then(function() { i.play() }).catch(function(A) {
                        ...
                        }).catch(function(A) { a.html.querySelector(".autoplay-many-video-ad").style.display = "block", a.html.querySelector(".icon-player-play").onclick = function() { a.playManyVideoAd(), a.html.querySelector(".autoplay-many-video-ad").style.display = "none" } })
                    })
                }
            }, {
                key: "ready",
                value: function(A, t) {
                    ...
                    var n = this;
                    this.html.querySelector("#many-video-ad-content" + this.indexVideo).addEventListener("ended", function(t) { "-1" == n.playNext(n) && A.play() }), this.html.querySelector(".many-video-ad-close label").onclick = function() { "function" == typeof e.adCloseFunction ? e.adCloseFunction(e) : e.closeManyVideoAd() }
                }
            }, {
                key: "setAdInterval",
                value: function(A) {
                ...
                value: function(A) {
                    ...
                    n.innerText = i, A.setAdInterval(), e.play(), e.addEventListener("ended", function(t) { "-1" == A.playNext(A) && document.getElementById("player-con").getElementsByTagName("video")[0].play() })
                }
            }, { key: "closeManyVideoAd", value: function() { this.clearAdInterval(), this.html.parentNode.removeChild(this.html), this.html = null, document.getElementById("player-con").getElementsByTagName("video")[0].play() } }]), A
        }(),
        XA = function() {
            function A(t, e) {
                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "关闭广告";
            ...
            return JA(A, [{
                ...
                value: function(A, t) {
                    ...
                    var i = A.querySelector(".prism-controlbar");
                    i.className = i.className + " controlbar-element-hidden", this.html.querySelector(".icon-player-play").onclick = function() { e.playManyVideoAd(), e.html.querySelector(".autoplay-many-video-ad").style.display = "none" }
                }
            }, {
                key: "created",
                value: function(A) {
                    ...
                    var e = this.indexVideo,
                        ...
                        o = this.html.querySelector(".many-video-ad-detail"),
                        r = this;
                    i.addEventListener("canplay", function A() { i.removeEventListener("canplay", A), o.href = n[e - 1].adVideoLink, r.html.querySelector("#many-video-ad-duration").innerText = Math.ceil(i.duration) })
                }
            }, {
                key: "ready",
                value: function(A) {
                    ...
                    }), this.html.querySelector(".many-video-ad-close label").onclick = function() { "function" == typeof t.adCloseFunction ? t.adCloseFunction(t) : t.closeManyVideoAd() }
                }
            }, {
                key: "setAdInterval",
                value: function() {
